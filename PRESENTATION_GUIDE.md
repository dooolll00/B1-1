...
- 저장소는 [B1-1](https://github.com/dooolll00/B1-1), 제출 URL은 [Pages](https://dooolll00.github.io/B1-1/)입니다. 최신 배포 결과는 WORK_LOG.md에서 확인합니다. 상태 변경과 모의 API 시연은 로컬 사이트에서 진행합니다.
...
> 사이트는 GitHub Pages로 제공합니다. 디자인과 기능을 유지하면서 중복 코드를 정리했고, 2026년 9월 16일 Chrome에서 모의 API 검사 27개와 실제 API·공개 사이트 검사 2개가 통과했습니다. 당시 공개본은 마지막 내부 정리 전 코드였으며, 최신 배포 결과는 작업 기록에서 확인할 수 있습니다.
