...
- 제출 URL은 [기존 Pages](https://dooolll00.github.io/B1-1/)입니다. 이번 수정이 push되기 전에는 로컬과 Footer 메뉴·데이터 검증이 다릅니다.
...
맨 위 버튼과 README 체크리스트를 보여 줍니다. 배포 상태는 README의 현황대로 말합니다. 아직 push 전이면 “기존 배포 URL이 있고, 이번 수정은 로컬 검증을 완료했습니다”라고 설명합니다.
